...
import { ActivityRoutes } from "./domains/activity/routes/activity.routes";
...
class Application {
  ...
  private initializeRoutes(): void {
    ...
    const activityRoutes = Container.get(ActivityRoutes)
    ...
    this.app.use("/api/activities", activityRoutes.getRoutes());
